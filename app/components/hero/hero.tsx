  ...
  return (
    <div>
      <h1 className="sr-only">
        Hello I&apos;m Manas Kumar Sinha, I&apos;m a Software Developer and Data Scientist,
        passionate about building innovative web solutions and extracting actionable insights from
        data.
      </h1>
          ...
          <div className="-mt-36">
            <div ref={ref} className="flex cursor-default flex-col space-y-2">
              ...
              <h2 className="text-3xl font-medium opacity-80 sm:text-6xl md:text-6xl xl:text-7xl">
                I build intuitive web solutions and uncover insights from data.
              </h2>
              <Link
                href="/about"
